...
import socialMediaImage from '@assets/generated_images/social_media_marketing.png';
...
const services = [
  ...
  },
  {
    ...
    description: "Boost your brand's presence, engagement, and reach across major social media platforms.",
  },
];
