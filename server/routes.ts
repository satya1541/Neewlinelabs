...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/contact", async (req, res, next) => {
    try {
      ...
      // Send email
      console.log("Attempting to send email to recipient:", process.env.RECIPIENT_EMAIL || 'contact-us@newlinelabs.tech');
      await sendContactEmail(contactData);
      console.log("Email sent successfully to:", process.env.RECIPIENT_EMAIL || 'contact-us@newlinelabs.tech');
